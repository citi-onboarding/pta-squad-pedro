...
export default function AppoitmentPage() {
    return (
        ...
        <div className="w-full min-h-screen "> 
            <div className="px-4 sm:px-8 xl:px-48 2xl:px-72 pt-10 pb-20">
                ...
                <div className="flex flex-col lg:flex-row lg:justify-start gap-12 lg:gap-[150px]">
                    <div className="w-full lg:w-[680px]">
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:items-start mb-8">
                            <Image src={Gato} alt="Gato" width={295} height={299} className="w-28 h-28 sm:w-40 sm:h-40 lg:w-[295px] lg:h-[299px] sm:mr-8 object-contain" />
                            <div className="mt-4 sm:mt-8 text-center sm:text-left lg:ml-[45px]">
                                <div className="font-[700] text-lg">Luna</div> 
                                <div className="font-[400] text-lg">5 anos</div>
                                <div className="font-[400] text-sm mt-4 lg:mt-[126px]">Lucas Gomes</div> 
                                <div className="font-[400] text-sm">Dr. José Carlos</div>
                            </div>
                        </div>
                        <div className="mt-8 lg:mt-[60px]">
                            <div className="font-[700] text-base mb-2">Descrição do problema:</div>
                            <div className="font-[400] text-base w-full sm:max-w-md lg:max-w-none">
                        ...
                        rounded-[24px] p-4 flex flex-col justify-center "> 
                            ...
                            <Button className="w-full rounded-[12px] h-12 bg-[#50E678] hover:bg-green-600 flex items-center justify-center">
                    ...
                    <div className="w-full mt-0 lg:ml-[339px]">
