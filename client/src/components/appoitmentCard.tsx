...
export default function CardConsulta({ date, time, type, doctor }: CardConsultaProps) {
    const displayDate = date && date.includes('-') 
    ...
    return(
        <div className="flex items-center w-full h-20 lg:w-[510px] lg:h-[82px] rounded-[16px] 
            ...
            gap-x-4 lg:gap-x-[61.67px] overflow-hidden mb-3"> 
